...
def run_graph_structure_tests(config_path: str, seeds: List[int], variants: List[str], device: str) -> dict:
    ...
    temp_root = Path("outputs/graph_structure_tests_structure_aware_v2")
    ...
    for variant in variants:
        for seed in seeds:
            ...
            config["paths"]["output_dir"] = f"outputs/graph_structure_tests_structure_aware_v2/{variant}_seed{seed}"
            ...
            cmd = [
                "python",
                "-m",
                "research.train_structure_aware_v2",
                "--config",
            ...
            summary[variant].append(
                {
                    ...
                    "test_graph_only_loss": metrics.get("graph_only_loss", 0.0),
    ...
    out_path = temp_root / "graph_structure_tests_structure_aware_v2_summary.json"
