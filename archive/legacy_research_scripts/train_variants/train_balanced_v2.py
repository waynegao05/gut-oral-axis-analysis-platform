...
from research.data_balanced import build_dataset_from_csv, set_seed
...
def main() -> None:
    ...
    parser.add_argument("--config", default="research_config_balanced_eval_v2.yaml")
    ...
    if split_summary["train"]["size"] == 0 or split_summary["val"]["size"] == 0 or split_summary["test"]["size"] == 0:
        raise RuntimeError("At least one split is empty. Please revise split construction.")
